...
## 二、当前阶段：Phase 1 完成，Phase 2 启动

```
Phase 1: MVP 巩固     ████████████████████ 100% ← 现在在这里
Phase 2: 核心增强     ████░░░░░░░░░░░░░░░░  20%
Phase 3: 专业升级     ░░░░░░░░░░░░░░░░░░░░   0%
Phase 4: 平台化       ░░░░░░░░░░░░░░░░░░░░   0%
```
...
优先级  任务                预计工时  说明
─────────────────────────────────────────────────────
P0      配置通义万相 Key     5min     配了才能出图片+视频（当前最卡点）
P1      多 LLM 供应商       8h       DeepSeek/Qwen/GLM 可选
P2      Image Provider 抽象  6h       SD/FLUX/DALL-E 接入
P3      缓存机制            6h       相同 prompt 不重复调用
P4      RIFE 60fps 插帧     6h       图片→60fps 视频
P5      多转场自动编排       4h       按情绪选转场
P6      字幕样式定制         3h       字体/颜色/位置
```
...
| 图像生成 | 通义万相 (未配置) | 50张/天免费 | SD, FLUX, DALL-E |
...
1. **缺少图片 API Key** — 通义万相未配置，流水线到第4步自动跳过，最终无法合成视频
2. **TTS 声线匹配不完善** — `voice_style` 是描述性文本（如"清脆、充满童真"），不是精确的声线名称，需要改进匹配逻辑
